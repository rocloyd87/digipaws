...
| Truth ledger | MoneyMatter (budget.rocloyd.com) — REST + MCP connector (`6a4e16af…`) | 30 accounts (GoTyme added 2026-09-03, `01a064cb-0d24-72e8-a823-6acb65c3e3df`); ids in `_DASH_SYNC_STATE` / BALANCE_CONTROL join. The MCP has no create-account tool — accounts are created in the web UI. |
